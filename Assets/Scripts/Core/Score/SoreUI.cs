...
public class SoreUI : MonoBehaviour
{
    ...
    public void Init(IScoreManager score)
    {
        _scoreManager = score;

        if (_scoreManager != null)
        {
            _targetScore = _scoreManager.CurrentScore;
        ...
        {
            _targetScore = PlayerPrefs.GetInt("Score", 0);
            _displayedScore = _targetScore;
    ...
    {
        if (_scoreManager != null) _scoreManager.OnScoreChanged -= OnScoreChanged;
