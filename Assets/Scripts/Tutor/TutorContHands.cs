...
public class TutorContHands : MonoBehaviour
{
    [Header("Ссылки")]
    ...
    [SerializeField] private TutorHandGrab _leftHandGrabs;
    [SerializeField] private TutorHandGrab _rightHandGrabs;
    ...
    public TutorContHands otherHands;
    //Ввод игрока
